---
title: "Final Project"
author: "Ingrid J. Lu 260773949; Grace Ma 260761707 ; Xinbei Wan 260777034; Wanqi Wang"
...
## a) {-}
Is this data ready for you to work with? If no, transform it into a ready to use form, if yes, explain.
...
Use a density graph, show her the distribution of fetal movements according to different fetal health classifications. Interpret to her the meaning of the box plots.
...
If you want to use a logistic regression model to use **Number of fetal movements per second** to the predict the classification of fetal health outcome. Describe how will you process these three variables to fit a logistic regression. 
...
Suppose the normal number of fetal movements per second is within 0.01. Fit the logistic regression model and provide a 95% CI. 
...
You decided to draw a ROC curve and see how well your model works out. Use the pROC package to draw the curve, and comment on what you see.
