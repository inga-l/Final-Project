...
Looking at the 3 different classification of fetal health status and each fetus' baseline heart rate, provide an appropriate graphic summarizing the distribution of each of baseline heart rates for each class. Be sure to provide the correct title and label for the plot. Comment on the boxplot, what are the characteristics of each category?
...
Rate: 0.3
95% CI: [0.20,0.43]
We are 95% confident that the true rate would fall ub this region of the confidence interval [0.20,0.43].
...
Your sister's partner said, their obstetrician told them that the Fetal Heart Rate could be a reflection of a lower value of short term variability. Can you conduct a linear regression to test it? Is there evidence of a statistically significant association bewteen baseline heart rate and value of short term variability at $\alpha$ = 0.05?
...
summary(reg1)
```
No. According to the linear regression, the p-value of the baseline heart rate is 0.139, which is greater than $\alpha$ = 0.05. There is no evidence of a statistically significant association between baseline heart rate and value of short term variability. 
